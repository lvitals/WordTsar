...
void cDocument::IncrementAttributes(POSITION_T position, POSITION_T length, bool changeparaindex)
{
    ...
    for_each(iter, iterend, [](TabPair &x)
             {x.first += glength; return x; });
    ...
    for_each(iter1, iter1end, [](FormatPair &x)
             {x.first += glength; return x; });
    ...
    for_each(iter2, iter2end, [](FontPair &x)
             {x.first += glength; return x; });
    ...
    for_each(iter3, iter3end, [](ColorPair &x)
             {x.first += glength; return x; });
    ...
    for_each(iter4, iter4end, [](FootnotePair &x)
             {x.first += glength; return x; });
    ...
    for_each(iter5, iter5end, [](EndnotePair &x)
             {x.first += glength; return x; });
    ...
    for_each(iter10, iter10end, [](PairTable &x)
             {x.first += glength; return x; });
...
void cDocument::DecrementAttributes(POSITION_T position, POSITION_T length, bool changeparaindex)
{
    ...
    for_each(iter4, iter4end, [](PairTable &x)
             {x.first -= glength; return x; });
