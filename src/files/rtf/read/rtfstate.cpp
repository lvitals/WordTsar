...
{
    return mBold == newstate.mBold && mItalics == newstate.mItalics && mUnderline == newstate.mUnderline && mStrikethrough == newstate.mStrikethrough && mHidden == newstate.mHidden && mDnup == newstate.mDnup && mSubscript == newstate.mSubscript && mSuperscript == newstate.mSuperscript && mFontsize == newstate.mFontsize && mFont == newstate.mFont && mTextcolor == newstate.mTextcolor && mBackgroundcolor == newstate.mBackgroundcolor && mSmallCaps == newstate.mSmallCaps;
}
