...
///
/////////////////////////////////////////////////////////////////////////////
bool cWordstarFile::CheckType(QString filename)
{
...
///
/////////////////////////////////////////////////////////////////////////////
bool cWordstarFile::LoadFile(QString filename)
{
    bool retval = false;
    mInIndex = false;

    // Limpa o conteúdo existente antes de carregar um novo arquivo
    mDocument->Clear(); // Certifique-se de que esta função limpa o documento ou buffer associado

    mFile = fopen(filename.toUtf8().constData(), "rb");
    if (mFile)
    {
...
/////////////////////////////////////////////////////////////////////////////
bool cWordstarFile::SaveFile(QString filename, POSITION_T length)
{
    bool retval = false;

    /// @todo we ned to check to see if it can be saved as Wordstar fromat (i.e. Unicode chars)

    mFile = fopen(filename.toUtf8().constData(), "wb");
    if (mFile)
    {
...
QString cWordstarFile::GetExtensions(void)
{
